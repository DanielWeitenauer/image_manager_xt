...
Dieser EP wird sehr früh im Verlauf des IM Codes aufgerufen (in der _config.inc.php_), er erlaubt Zugriff auf folgende Variablen im übergebenen @$params@ array:
