...
*Achtung:* Die Funktionalität ist beschränkt auf den ImageManager, d.h. der Medienpool wird durch dieses Plugin *nicht* erweitert.
...
@files/addons/image_manager/plugins/rex_img_dir.imagemanager.plugin@ kopiert.
